...
namespace UserInterfaces
{
    namespace BAUX
    {
        ...
        public:
            ...
            ledStateUpdate(void)
            {
                ...
                case LED_STATE_BOOT:
                    if (m_wdog.overflow())
                    {
                        ...
                        {
                        case 0:
                            m_baux->setLed(BAUXDriver::LED_RED, BAUXDriver::POWER_ON);
                            m_baux->setLed(BAUXDriver::LED_GREEN, BAUXDriver::POWER_OFF);
                            m_baux->setLed(BAUXDriver::LED_BLUE, BAUXDriver::POWER_OFF);
                            m_wdog.setTop(0.2);
                            m_counter_state++;
                            break;

                        case 1:
                            m_baux->setLed(BAUXDriver::LED_RED, BAUXDriver::POWER_OFF);
                            m_baux->setLed(BAUXDriver::LED_GREEN, BAUXDriver::POWER_ON);
                            m_baux->setLed(BAUXDriver::LED_BLUE, BAUXDriver::POWER_OFF);
                            m_wdog.setTop(0.2);
                            m_counter_state++;
                            break;
                        ...
                        case 2:
                            m_baux->setLed(BAUXDriver::LED_RED, BAUXDriver::POWER_OFF);
                            m_baux->setLed(BAUXDriver::LED_GREEN, BAUXDriver::POWER_OFF);
                            m_baux->setLed(BAUXDriver::LED_BLUE, BAUXDriver::POWER_ON);
                            m_wdog.setTop(0.2);
                            m_counter_state++;
                            break;
            ...
            {
                m_baux->setLed(led_id, true);
            }

            void
            turnLedOff(uint8_t led_id)
            {
                m_baux->setLed(led_id, false);
            }
